  ...
  return (
    <Sidebar collapsible="offcanvas" {...props}>
      ...
      <button
        ...
        className={`sidebar-toggle-button fixed top-1/2 -translate-y-1/2 z-20 hidden md:flex h-8 w-8 items-center justify-center rounded-full border bg-white shadow hover:bg-slate-50 transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] ${
